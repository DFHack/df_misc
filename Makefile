...
tthread.o: ../depends/tthread/tinythread.cpp
	gcc -fPIC -O2 -I ../depends/tthread/ -c -o $@ $<

ruby.plug.so: tthread.o ruby.cpp
	gcc -W -Wall -Wno-unused-parameter -lruby1.8 -std=c++0x -fPIC -O2 -DLINUX_BUILD -I ../library/include/ -I ../depends/tthread/ -I /usr/lib/ruby/1.8/i486-linux/ -shared -o $@ $^
